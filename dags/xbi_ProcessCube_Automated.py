...
def GetAndInsertDataProcessCube():
    ...
    sql = """CREATE TABLE if not exists test.get_ProcessCube ( ID Int32, IDcampCat Int32,ActivityID Int32,Yr Int32,TimeStamp DateTime('Asia/Karachi'), Cday Int32, TehsilID Int32, UCID Int32 
            ...
            ,VaccinationDate DateTime('Asia/Karachi'),OPVGiven Int32,OPVUsed Int32,OPVReturned Int32,Remarks String,status Int32,trash Int32,isSync Int32,location_code Int32)ENGINE = MergeTree PRIMARY KEY ID ORDER BY ID"""
    client.execute(sql)
    ...
    df = client.query_dataframe(
                """SELECT ID,	IDcampCat,	ActivityID,	Yr,	TimeStamp,	Cday,	TehsilID,	UCID, 
                    ...
                    -- CR = CU = ACU --
                    ,VaccinationDate,OPVGiven,OPVUsed,OPVReturned,Remarks,status,trash,isSync,location_code
                    ...
                    -- CR = CU = ACU --
                    ,NULL AS VaccinationDate,OPVGiven,OPVUsed,CAST(OPVReturned AS INT)OPVReturned ,Remarks,status,trash,isSync,location_code
                    ...
                    ,PersistentlyMC,PersistentlyMCHRMP,fm_issued,fm_retrieved
                    -- CR = CU = ACU --
                    ,VaccinationDate,OPVGiven,OPVUsed,CAST(OPVReturned AS INT)OPVReturned ,Remarks,status,trash,isSync,location_code
    ...
    client.insert_dataframe(
        'INSERT INTO test.get_ProcessCube  VALUES', df)
    logger.info(
            ' Data has been inserted into Table\' INSERT INTO test.get_ProcessCube VALUES \' ')            
...
def CreateJoinTableOfProcessCube():
    ...
    sql = """CREATE TABLE if not exists test.xbi_ProcessCube( ID Int32, IDcampCat Int32,ActivityID Int32,Yr Int32,TimeStamp DateTime('Asia/Karachi'), Cday Int32, TehsilID Int32, UCID Int32 
            ,ccpvTargets Int32,TeamsRpt Int32,HH011_MP Int32,HH1259_MP Int32,HH011_TS Int32,HH1259_TS Int32,HH011 Int32,HH1259 Int32,OutofH011 Int32,OutofH1259 Int32, RecNA011 Int32,RecNA1259 Int32,RecRef011 Int32,RecRef1259 Int32,CovNA011 Int32,CovNA1259 Int32,CovRef011 Int32,CovRef1259 Int32,Guests Int32,VaccinatedSchool Int32,NewBorn Int32,AlreadyVaccinated Int32,FixSite011 Int32,FixSite1259 Int32,Transit011 Int32,Transit1259 Int32,CovMob Int32,HHvisit Int32,HHPlan Int32,MultipleFamily String,Weakness Int32,ZeroRt Int32,Stage34 Int32,Inaccessible Int32,V_Age611 Int32,v_Age1259 Int32,V_capGiven Int32,V_capUsed Int32,V_capRet Int32,trigers String,Covid19 Int32,campcat_name String
            ,UserName String,DistID Int32,DivID Int32,ProvID Int32
            ,CCovNA011 Int32,CCovNA1259 Int32,CCovRef011 Int32,CCovRef1259 Int32,COutofH011 Int32,COutofH1259 Int32,CGuests Int32,CCovMob Int32,CNewBorn Int32,CAlreadyVaccinated Int32,CFixSite011 Int32,CFixSite1259 Int32,CTransit011 Int32,CTransit1259 Int32,UnRecorded_Cov Int32,AFP_CaseRpt Int32,ZeroDos1 Int32,V_Age611_CP Int32,v_Age1259_CP Int32,missing_vacc_carr Int32,missing_vacc_carr_reason String
            ,ACCovNA011 Int32,ACCovNA1259 Int32,ACCovRef011 Int32,ACCovRef1259 Int32,ACOutofH011 Int32,ACOutofH1259 Int32,ACGuests Int32,ACCovMob Int32,ACNewBorn Int32,ACAlreadyVaccinated Int32,UnRecCov Int32
            ,PersistentlyMC Int32,PersistentlyMCHRMP Int32, fm_issued Int32,fm_retrieved Int32
            ,VaccinationDate DateTime('Asia/Karachi'),OPVGiven Int32,OPVUsed Int32,OPVReturned Int32,Remarks String,status Int32,trash Int32,isSync Int32,location_code Int32
    ...
    cols = """
            ...
            ,eoc_1.VaccinationDate,eoc_1.OPVGiven,eoc_1.OPVUsed,eoc_1.OPVReturned,eoc_1.Remarks,eoc_1.status,eoc_1.trash,eoc_1.isSync,eoc_1.location_code,

            eoc_3.campaign_ID, eoc_3.campaign_ActivityName, eoc_3.campaign_ActivityID_old, eoc_3.campaign_Yr, eoc_3.campaign_SubActivityName,  
                
            eoc_2.name, eoc_2.type, eoc_2.code, eoc_2.census_pop, eoc_2.target, eoc_2.status, eoc_2.pname, eoc_2.dname, eoc_2.namedistrict, eoc_2.codedistrict, eoc_2.tname, eoc_2.provincecode, eoc_2.districtcode, eoc_2.tehsilcode, eoc_2.priority, eoc_2.commnet, eoc_2.hr, eoc_2.fcm, eoc_2.tier, eoc_2.block, eoc_2.division, eoc_2.cordinates, eoc_2.latitude, eoc_2.longitude, eoc_2.x, eoc_2.y, eoc_2.imagepath, eoc_2.isccpv, eoc_2.rank, eoc_2.rank_score, eoc_2.ishealthcamp, eoc_2.isdsc, eoc_2.ucorg, eoc_2.organization, eoc_2.tierfromaug161, eoc_2.tierfromsep171, eoc_2.tierfromdec181, eoc_2.mtap, eoc_2.rspuc, eoc_2.issmt, eoc_2.updateddatetime, eoc_2.x_code, eoc_2.draining_uc, eoc_2.upap_districts, eoc_2.shruc, eoc_2.khidist_id
            """
    sql = "SELECT " + cols + "  FROM test.get_ProcessCube  eoc_1 left JOIN test.eoc_geolocation_t eoc_2 ON eoc_1.location_code  = eoc_2.code left JOIN test.xbi_campaign eoc_3 ON (eoc_1.ActivityID  = eoc_3.campaign_ActivityID_old And eoc_1.Yr = eoc_3.campaign_Yr) "
    ...
    logger.info(
            'Get Data from test.get_ProcessCube for campaign'+str(cid)+' '+str(y))

    df3 = client.query_dataframe(
                     "SELECT * FROM test.xbi_ProcessCube WHERE Yr = 2022 and ActivityID = 2")
    if df3.empty:
        client.insert_dataframe(
            'INSERT INTO test.xbi_ProcessCube VALUES', dff)
        logger.info(
            'Data has been inserted into Table test.xbi_ProcessCube for campaign '+str(cid)+' '+str(y))

        sql = "DROP table if exists test.get_ProcessCube"
        client.execute(sql)
        
    else:
        sql = "ALTER TABLE test.xbi_ProcessCube DELETE WHERE Yr = 2022 and ActivityID = 2"
        client.execute(sql)
...
#         dff[item] = xbiDataFrame[index].values
#     logger.info(
#             'Get Data from test.get_ProcessCube for campaign')#+str(cid))
...
#             'INSERT INTO test.xbi_ProcessCube VALUES', dff)
#         logger.info(
#             'Data has been inserted into Table test.xbi_ProcessCubefor campaign ')#+str(cid))
...
#     else:
#         client.insert_dataframe(
#             'INSERT INTO test.xbi_ProcessCubeVALUES', dff)
#         logger.info(
#             ' Data has been inserted into Table test.xbi_ProcessCubefor campaign ')#+str(cid))    
