...
def GetAndInsertApiAIC():
    ...
    sql = "CREATE TABLE if not exists test.get_test_aic (pk_icm_mobile_2b_id Int32,fk_parent_id Int32,team_leader Int32,team_member Int32,child_mp_0_11 Int32,child_mp_12_59 Int32,child_telysheet_0_11 Int32,child_telysheet_12_59 Int32,child_vaccinated_0_11 Int32,child_vaccinated_12_59 Int32,recorded_missed_0_11 Int32,covered_missed_0_11 Int32,covered_missed_12_59 Int32,school_covered Int32,guest_vaccinated Int32,hrmp_vaccinated Int32,vaccine_received Int32,vaccine_used Int32,vaccine_returned Int32,afp_cases Int32,zero_ri_recorded Int32,vitamin_a_red Int32,vitamin_a_blue Int32,area_aic String,area_aic_code Int32,recorded_missed_na_0_11 Int32,recorded_missed_na_12_59 Int32,recorded_missed_refusal_0_11 Int32,recorded_missed_refusal_12_59 Int32,covered_missed_na_0_11 Int32,covered_missed_na_12_59 Int32,covered_missed_refusal_0_11 Int32,covered_missed_refusal_12_59 Int32,guest_vaccinated_street Int32,mobile_teams Int32,fixed_sites Int32,transit_sites Int32,f_child_vac_total Int32,f_vaccine_received Int32,f_vaccine_returned Int32,f_afp_cases Int32,f_zero_ri_recorded Int32,f_vaccine_used Int32,t_child_vac_total Int32,t_vaccine_received Int32,t_vaccine_returned Int32,t_afp_cases Int32,t_zero_ri_recorded Int32,t_vaccine_used Int32,HHPlan Int32,HHvisit Int32,Covid19 Int32,fm_issued Int32,pk_icm_2b_id Int32,date_created  DateTime,fk_prov_id Int32,fk_dist_id String,fk_tehsil_id Int32,fk_uc_id Int32,campaign_id Int32,cday Int32,camp_type Int32,aic_name String,date1 Date,total_vac_given_mt String,total_vac_used_mt String,total_vac_returned_mt String,total_vac_used_fixed String,total_vac_given_fixed String,total_vac_returned_fixed String,total_vac_used_transit String,total_vac_given_transit String,total_vac_returned_transit String,unique_id String,uc_incharge_name String,aic_reported Int32,form_2b_pic String,fixed_sub String,is_archive Int32)ENGINE = MergeTree PRIMARY KEY pk_icm_2b_id ORDER BY pk_icm_2b_id"
    # sql = "CREATE TABLE if not exists test.get_test_aic (pk_icm_mobile_2b_id Int32,fk_parent_id Int32,team_leader Int32,team_member Int32,child_mp_0_11 Int32,child_mp_12_59 Int32,child_telysheet_0_11 Int32,child_telysheet_12_59 Int32,child_vaccinated_0_11 Int32,child_vaccinated_12_59 Int32,recorded_missed_0_11 Int32,covered_missed_0_11 Int32,covered_missed_12_59 Int32,school_covered Int32,guest_vaccinated Int32,hrmp_vaccinated Int32,vaccine_received Int32,vaccine_used Int32,vaccine_returned Int32,afp_cases Int32,zero_ri_recorded Int32,vitamin_a_red Int32,vitamin_a_blue Int32,area_aic String,area_aic_code Int32,recorded_missed_na_0_11 Int32,recorded_missed_na_12_59 Int32,recorded_missed_refusal_0_11 Int32,recorded_missed_refusal_12_59 Int32,covered_missed_na_0_11 Int32,covered_missed_na_12_59 Int32,covered_missed_refusal_0_11 Int32,covered_missed_refusal_12_59 Int32,guest_vaccinated_street Int32,mobile_teams Int32,fixed_sites Int32,transit_sites Int32,f_child_vac_total Int32,f_vaccine_received Int32,f_vaccine_returned Int32,f_afp_cases Int32,f_zero_ri_recorded Int32,f_vaccine_used Int32,t_child_vac_total Int32,t_vaccine_received Int32,t_vaccine_returned Int32,t_afp_cases Int32,t_zero_ri_recorded Int32,t_vaccine_used Int32,HHPlan Int32,HHvisit Int32,Covid19 Int32,fm_issued Int32,pk_icm_2b_id Int32,date_created  DateTime,fk_prov_id Int32,fk_dist_id String,fk_tehsil_id Int32,fk_uc_id Int32,campaign_id Int32,cday Int32,camp_type Int32,aic_name String,date1 Int32,total_vac_given_mt String,total_vac_used_mt String,total_vac_returned_mt String,total_vac_used_fixed String,total_vac_given_fixed String,total_vac_returned_fixed String,total_vac_used_transit String,total_vac_given_transit String,total_vac_returned_transit String,unique_id String,uc_incharge_name String,aic_reported Int32,form_2b_pic String,fixed_sub String,is_archive Int32,date_updated DateTime('Asia/Karachi')))ENGINE = MergeTree PRIMARY KEY pk_icm_2b_id ORDER BY pk_icm_2b_id"
    print(sql)
    client.execute(sql)
        # pk_icm_mobile_2b_id Int32,
        # fk_parent_id Int32,
        # team_leader Int32,
        # team_member Int32,
        # child_mp_0_11 Int32,
        # child_mp_12_59 Int32,
        # child_telysheet_0_11 Int32,
        # child_telysheet_12_59 Int32,
        # child_vaccinated_0_11 Int32,
        # child_vaccinated_12_59 Int32,
        # recorded_missed_0_11 Int32,
        # recorded_missed_12_59 Int32,
        # covered_missed_0_11 Int32,
        # covered_missed_12_59 Int32,
        # school_covered Int32,
        # guest_vaccinated Int32
        # hrmp_vaccinated Int32,
        # vaccine_received Int32,
        # vaccine_used Int32,
        # vaccine_returned Int32,
        # afp_cases Int32,
        # zero_ri_recorded Int32,
        # vitamin_a_red Int32,
        # vitamin_a_blue Int32,
        # area_aic String,
        # area_aic_code Int32
        # recorded_missed_na_0_11 Int32,
        # recorded_missed_na_12_59 Int32,
        # recorded_missed_refusal_0_11 Int32,
        # recorded_missed_refusal_12_59 Int32,
        # covered_missed_na_0_11 Int32
        # covered_missed_na_12_59 Int32,
        # covered_missed_refusal_0_11 Int32,
        # covered_missed_refusal_12_59 Int32,
        # guest_vaccinated_street Int32,
        # mobile_teams Int32,
        # fixed_sites Int32,
        # transit_sites Int32,
        # f_child_vac_total Int32,
        # f_vaccine_received Int32,
        # f_vaccine_returned Int32,
        # f_afp_cases Int32,
        # f_zero_ri_recorded Int32,
        # f_vaccine_used Int32
        # t_child_vac_total Int32,
        # t_vaccine_received Int32,
        # t_vaccine_returned Int32,
        # t_afp_cases Int32,
        # t_zero_ri_recorded Int32,
        # t_vaccine_used Int32,
        # HHPlan Int32,
        # HHvisit Int32,
        # Covid19 Int32,
        # fm_issued Int32,
        ...
        # lot_no Int32,
        # total Int32, 
        # date_updated DateTime('Asia/Karachi')))ENGINE = MergeTree PRIMARY KEY pk_icm_2b_id ORDER BY pk_icm_2b_id"
    ...
    #         df2 = pd.read_json(data_c, orient ='index')
    #         print(df2)
    #         # for i in range(len(apiDataFrame)):
    #         #     df = pd.DataFrame(
    #         #         apiDataFrame.loc[i, "pk_icm_2b_id"],
    #         #         apiDataFrame.loc[i, "date_created"],
    #         #         apiDataFrame.loc[i, "fk_prov_id"],
    #         #         apiDataFrame.loc[i, "fk_dist_id"],
    #         #         apiDataFrame.loc[i, "fk_tehsil_id"],
    #         #         apiDataFrame.loc[i, "fk_uc_id"],
    #         #         apiDataFrame.loc[i, "campaign_id"],
    #         #         apiDataFrame.loc[i, "cday"],
    #         #         apiDataFrame.loc[i, "camp_type"],
    #         #         apiDataFrame.loc[i, "date1"],
    #         #         apiDataFrame.loc[i, "total_vac_given_mt"],
    #         #         apiDataFrame.loc[i, "total_vac_used_mt"],
    #         #         apiDataFrame.loc[i, "total_vac_returned_mt"],
    #         #         apiDataFrame.loc[i, "total_vac_used_fixed"],
    #         #         apiDataFrame.loc[i, "total_vac_given_fixed"],
    #         #         apiDataFrame.loc[i, "aic_name"],
    #         #         apiDataFrame.loc[i, "aic_name"],
    #         #         apiDataFrame.loc[i, "aic_name"],
    #         #         apiDataFrame.loc[i, "aic_name"]
    ...
    #         # apiDataFrame2 = pd.DataFrame(apiDataFrame['aic'])
    #         # # print(apiDataFrame2.head(5))
    #         # for i in range(len(apiDataFrame2)):
    #         #     apiDataFrame2 = pd.DataFrame(apiDataFrame.loc[i, "aic"])
    #         #     print(apiDataFrame2)
    #         #     print(i)
