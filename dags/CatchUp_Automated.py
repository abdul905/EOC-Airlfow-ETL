...
def GetAndInsertApiDataCatchUp():
    ...
    #url = 'http://idims.eoc.gov.pk/api_who/api/get_allcatchup/5468XE2LN6CzR7qRG041/1/2022'
    logger.info('Requested Data From Api URL:  \' http://idims.eoc.gov.pk/api_who/api/get_allcatchup/5468XE2LN6CzR7qRG041/"+ str(cid)+"/"+ str(y) \' ')
...
def CreateJoinTableOfCatchUp():
    ...
    df2 = client.query_dataframe(
        "SELECT * FROM test.xbi_catchUp WHERE Yr = 2022 and ActivityID = 2")
    if df2.empty:
        client.insert_dataframe(
        ...
        sql = "ALTER TABLE test.xbi_catchUp DELETE WHERE Yr = 2022 and ActivityID = 2"
        client.execute(sql)
